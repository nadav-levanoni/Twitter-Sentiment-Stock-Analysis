...
```{r, include=FALSE}
# I'm apparently not supposed to share these, but oh well lol

consumer_key <- "MmEM7Dv2MRVYJvpIZBsdJG9Pv"
consumer_secret <- "5lkFNFU8J6diUlyZxxjgxKD8RNGtRpBemIJtGLtittILzeM67j"
access_token <- "747887898586931200-93EfpApfGLT8tXkQEUmHB4vTbcykcxB"
access_secret <- "MhJ6KMX9EMk9mTPAsNrYZKJPPHE772jGbADyIRreqQicd"
